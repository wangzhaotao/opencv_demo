...
-(BOOL)isTouchLineWithPoint:(CGPoint)point {
    ...
    if (_point1.x == _point2.x) {
        ...
        if (fabs(point.x-_point1.x)<DXY && (point.y>=y_min && point.y<=y_max)) return YES;
